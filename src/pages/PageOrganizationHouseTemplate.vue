    		...
    		<div class="block__header">
    			...
    			<div class="row">
    				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-4" v-for="(module) in activeModules" :key="module.moduleNum">
    					<router-link class="module" :to="{name: 'PageOrganizationHouseTemplateModule', params: {organization_id:organization_id, house_id:house_id, module_id:module.moduleNum}}">
