      	...
      	<transition name="slideY">
		    <div class="custom-periodical__content" ref="content" v-if="isOpen">
		    	<div class="custom-periodical__items">
		    		<div class="custom-periodical__item" v-for="(quarter, index) in picked" :key="index">
			    		<span> {{ index + 1 }} квартал </span>
			    		<div class="custom-periodical__fields">
				    		<div class="form-control form-control--xs" v-for="(day, idx) in quarter" :key="idx">
				    			<input type="text" placeholder="dd.mm" v-model="picked[index][idx]">
				    		</div>
			    		</div>
			    		<div class="custom-periodical__buttons">
			    			<div class="custom-periodical__btn" @click="minusDays" v-show="quarter.length > 1">
			    			...
			    			<div class="custom-periodical__btn" @click="plusDays" v-show="quarter.length < 3">
